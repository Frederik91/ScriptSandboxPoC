...
public sealed class ScriptBox : IAsyncDisposable
{
    ...
    internal ScriptBox(WasmScriptExecutor executor, string bootstrapCode, TimeSpan defaultTimeout)
    {
    ...
    {
        return new ScriptSession(_executor, _bootstrapCode, timeout ?? _defaultTimeout);
    }
